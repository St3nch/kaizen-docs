...
- `008b-first-real-promotion-two-gate-execution.md` - corrected Gate A command re-audited pass in Result 037; renewed owner approval required; Gate B prohibited

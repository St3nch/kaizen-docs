...
- `008b-first-real-promotion-two-gate-execution.md` - command and docs-binding corrections re-audited through Result 038; renewed owner approval required; Gate B prohibited

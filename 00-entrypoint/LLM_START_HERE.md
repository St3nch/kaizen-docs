...
- Current gate: audit and owner acceptance for draft `05-specs/milestone-15-dynamic-obsidian-experience-and-typed-read-model.md`, created from M15 research synthesis in `03-research-results/384-m15-research-synthesis-and-tauri-aligned-direction.md`. M15 should define the Obsidian human cockpit, parser-backed typed read model, review/resume/current-state patterns, and context-pack contract that later Tauri can consume. M15 does not authorize Tauri implementation, Qdrant, Hermes write authority, Observatory / IMI implementation, platform mutation, vault mutation, or database mutation. Kaizen v1 remains accepted unless a later accepted audit records an acceptance-invalidating defect.
...
- Docs repository: synced to `origin/main` at commit `a2e831bd254c3c7b7e174e1f2c059da114c1c343`; verify current HEAD and sync posture before push or handoff work.

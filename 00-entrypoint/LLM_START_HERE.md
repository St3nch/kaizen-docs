...
- Current gate: first M15 implementation-packet planning after owner acceptance in `03-research-results/386-m15-definition-spec-owner-acceptance.md`. Accepted M15 spec is `05-specs/milestone-15-dynamic-obsidian-experience-and-typed-read-model.md` at spec commit `a8d9f1230b2ceb7997157188e78fcdeda3236b88`. Next recommended packet: 023D — M15 Note Schema and Parser Direction. M15 does not authorize Tauri implementation, Qdrant, Hermes write authority, Observatory / IMI implementation, platform mutation, vault mutation, or database mutation without a separately accepted implementation packet. Kaizen v1 remains accepted unless a later accepted audit records an acceptance-invalidating defect.
...
- Docs repository: synced to `origin/main` at commit `9413b0c860ba76ecdb60c7693ba637fcfc6e3a61`; verify current HEAD and sync posture before push or handoff work.

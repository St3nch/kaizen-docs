...
- Current gate: Retrieval expansion lane selection is recorded in `03-research-results/430-packet-025b-retrieval-expansion-options-and-gate-contract.md`. Milestone 16 is closed. Platform is at `c9f0be93048324cb5212700d9ccceeb9e1aa90ea`. Existing roadmap Milestone 17 remains Hermes constrained-clerk integration unless separately amended. Next recommended gate is `025C — Expanded Docs Corpus Boundary and Evaluation Contract`.

...
- Current gate: owner review / acceptance for Packet 023D planning draft in `03-research-results/387-packet-023d-m15-note-schema-and-parser-direction.md`. Accepted M15 spec is `05-specs/milestone-15-dynamic-obsidian-experience-and-typed-read-model.md` at spec commit `a8d9f1230b2ceb7997157188e78fcdeda3236b88`. Packet 023D defines the M15 note schema and parser direction; it does not authorize implementation, Tauri, Qdrant, Hermes write authority, Observatory / IMI implementation, platform mutation, vault mutation, or database mutation without separate approval. Kaizen v1 remains accepted unless a later accepted audit records an acceptance-invalidating defect.
...
- Docs repository: synced to `origin/main` at commit `9cbfd05f3d711f1fd8a73a08c1156573a7bca475`; verify current HEAD and sync posture before push or handoff work.

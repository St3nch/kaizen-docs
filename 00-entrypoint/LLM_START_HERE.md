...
- Current gate: Packet 014A Phase 2 is complete; the next gate is separate owner approval for Packet 014A Phase 3 and Packet 014B implementation
...
- Packet 014A Phase 2 is complete; immediate work is separate owner approval for Phase 3 and Packet 014B implementation; canonical Northstar mutation remains unauthorized
...
-> Packet 014A Phase 3 and Packet 014B implementation: separate owner gate
```

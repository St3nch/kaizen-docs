...
- Current gate: Expanded docs corpus boundary and evaluation contract is recorded in `03-research-results/431-packet-025c-expanded-docs-corpus-boundary-and-evaluation-contract.md`. Milestone 16 is closed. Platform is at `c9f0be93048324cb5212700d9ccceeb9e1aa90ea`. Existing roadmap Milestone 17 remains Hermes constrained-clerk integration unless separately amended. Next recommended gate is `025D — Expanded Docs Corpus Implementation`, requiring separate owner acceptance before platform mutation.

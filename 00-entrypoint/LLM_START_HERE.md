...
- Current gate: Post-M16 roadmap reconciliation is recorded in `03-research-results/429-packet-025a-post-m16-roadmap-reconciliation-and-next-gate-selection.md`. Milestone 16 is closed. Platform is at `c9f0be93048324cb5212700d9ccceeb9e1aa90ea`. Existing roadmap Milestone 17 remains Hermes constrained-clerk integration unless separately amended. Next recommended gate is `025B — Retrieval Expansion Options and Gate Contract`.

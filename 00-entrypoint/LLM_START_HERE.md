...
- Current gate: Milestone 16 is closed by `03-research-results/427-packet-024r-milestone-16-closure-record.md`, with handoff correction recorded in `03-research-results/428-packet-024s-milestone-16-closure-handoff-correction.md`. Platform is at `c9f0be93048324cb5212700d9ccceeb9e1aa90ea`. Next recommended retrieval gate is Retrieval Expansion Options and Gate Contract; do not assign it a milestone number until `ROADMAP_V0.4.md` is reconciled. Existing roadmap Milestone 17 remains Hermes constrained-clerk integration unless separately amended.
